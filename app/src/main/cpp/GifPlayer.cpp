...
void GifPlayer::setColorARGB(uint32_t *sPixels, int imageIndex, ColorMapObject *colorMap,
...
// RGBA_8888
void GifPlayer::drawBitmap(JNIEnv *env, int imageIndex, jobject bitmap, SavedImage *SavedImages,
                           ColorMapObject *ColorMap, GifRowType *ScreenBuffer, int bitmapWidth,
...
void GifPlayer::start(JNIEnv *env, jboolean once, jobject bitmap, jobject runnable) {
    PlayState playState;
    getPlayState(&playState);
