...
load_jni(JNIEnv *env, jobject instance, jlong gifPlayerFromJava,
        jobject assetManager, jstring gifPath_) {
    const char *gifPath = env->GetStringUTFChars(gifPath_, 0);
    GifPlayer *gifPlayer = (GifPlayer *) gifPlayerFromJava;
    jboolean ret;
    if (gifPlayer) {
...
start_jni(JNIEnv *env, jobject instance, jlong gifPlayerFromJava, jboolean once,
...
JNIEXPORT void JNICALL
pause_jni(JNIEnv *env, jobject instance, jlong gifPlayerFromJava) {
    GifPlayer *gifPlayer = (GifPlayer *) gifPlayerFromJava;
    if (gifPlayer) {
        gifPlayer->pause();
    }
...
JNIEXPORT void JNICALL
resume_jni(JNIEnv *env, jobject instance, jlong gifPlayerFromJava) {
    GifPlayer *gifPlayer = (GifPlayer *) gifPlayerFromJava;
    if (gifPlayer) {
        gifPlayer->resume();
    }
...
get_width_jni(JNIEnv *env, jobject instance, jlong gifPlayerFromJava) {
    GifPlayer *gifPlayer = (GifPlayer *) gifPlayerFromJava;
    if (gifPlayer) {
...
JNIEXPORT jint JNICALL
get_height_jni(JNIEnv *env, jobject instance, jlong gifPlayerFromJava) {
    GifPlayer *gifPlayer = (GifPlayer *) gifPlayerFromJava;
    if (gifPlayer) {
...
JNIEXPORT void JNICALL
stop_jni(JNIEnv *env, jobject instance, jlong gifPlayerFromJava) {
    GifPlayer *gifPlayer = (GifPlayer *) gifPlayerFromJava;
    if (gifPlayer) {
        gifPlayer->release();
    }
...
JNIEXPORT void JNICALL
release_jni(JNIEnv *env, jobject instance, jlong gifPlayerFromJava) {
    GifPlayer *gifPlayer = (GifPlayer *) gifPlayerFromJava;
    if (gifPlayer) {
        delete (gifPlayer);
    }
...
jint registerNativeMethod(JNIEnv *env) {
    jclass cl = env->FindClass("com/wangxingxing/ndkgifdemo/GifPlayer");
